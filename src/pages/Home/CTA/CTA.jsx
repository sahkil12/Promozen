...
const CTA = () => {
     return (
          <motion.section
               ...
               className="px-6 inter">
               <div className="max-w-5xl mx-auto">
                    {/* Main CTA Container */}
                    <div className="relative overflow-hidden rounded-4xl bg-base-200/40 border border-primary/20 py-12 px-10 text-center">
                         ...
                         {/* Title */}
                         <h2 className="text-4xl poppins lg:text-5xl font-bold text-base-100 mb-6 leading-tight max-w-3xl mx-auto">
                              Ready to <span className="text-primary">Transform</span> Your Brand?
                         </h2>
                         {/* Description */}
                         <p className="text-[#a1a1a1] text-lg  max-w-2xl mx-auto mb-10 leading-relaxed">
