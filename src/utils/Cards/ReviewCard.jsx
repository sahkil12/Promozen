...
const ReviewCard = ({ review, isActive }) => {
     return (
          <motion.div
               className={`group relative p-8 md:p-10 rounded-3xl bg-base-200/25 border hover:border-primary/30 transition-all duration-600 my-14 hover:drop-shadow-[0_0_40px_rgba(242,201,76,0.1)]
               ${isActive ? "opacity-100 scale-100 -translate-y-10 drop-shadow-[0_0_40px_rgba(242,201,76,0.1)] border-primary/30" : "border-base-100/5 opacity-35 scale-90"}`}
          >
               {/* Quote Icon */}
